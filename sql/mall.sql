...
INSERT INTO `oms_cart_item` VALUES (42, 25, 25, 10, 1, 1199.00, 'https://img.alicdn.com/imgextra/i3/1125378539/TB2mCXLX6TpK1RjSZKPXXa3UpXa_!!1125378539.jpg_430x430q90.jpg', '天王表钢带简约情侣手表男士女士休闲石英表生日礼物3798', '天王表钢带简约情侣手表男士女士休闲石英表生日礼物3798', '202109150027025', 'lucien_ssa', '2021-09-13 10:20:35', '2021-09-13 10:20:35', 1, 21, '范思哲', '3534534', NULL);
INSERT INTO `oms_cart_item` VALUES (43, 10, 10, 10, 1, 119.00, 'http://yanxuan.nosdn.127.net/337da7094c1df295ca0f0b8baa55b2d5.png', '方形封闭式宠物窝 封闭式设计猫咪独享', '方形封闭式宠物窝 封闭式设计猫咪独享', '202109150027010', 'lucien_ssa', '2021-09-13 10:20:50', '2021-09-13 10:20:50', 1, 54, '万和', '4523434', NULL);
INSERT INTO `oms_cart_item` VALUES (44, 30, 30, 10, 1, 139.00, 'https://img.alicdn.com/imgextra/i3/833261111/O1CN014MMkx01K4sfv0hKnn_!!833261111.png_430x430q90.jpg', '新品 眼镜厂 鬼灭之刃景品手办 绊之装玖之型蝴蝶忍', '新品 眼镜厂 鬼灭之刃景品手办 绊之装玖之型蝴蝶忍', '202109150027030', 'lucien_ssa', '2021-09-13 10:42:17', '2021-09-13 10:42:17', 1, 61, '范思哲', '6343122', NULL);
INSERT INTO `oms_cart_item` VALUES (45, 19, 19, 10, 1, 1778.00, 'https://img.alicdn.com/imgextra/i2/2200877014436/O1CN01anNk4S1idjZTDktag_!!2200877014436.jpg_430x430q90.jpg', '【直营国行】Apple/苹果 AirPods Pro耳机三代原装正品 全国联保', '【直营国行】Apple/苹果 AirPods Pro耳机三代原装正品 全国联保', '202109150027019', 'lucien_ssa', '2021-09-13 10:50:15', '2021-09-13 10:50:15', 1, 31, '苹果', '2354344', NULL);
...
INSERT INTO `oms_cart_item` VALUES (48, 33, 33, 10, 1, 228.00, 'https://gd3.alicdn.com/imgextra/i3/3381629725/O1CN01QaB5cG2Li6E4KJn0M_!!3381629725.jpg_400x400.jpg', '海洋堂新世纪福音战士EVA成品初号机', '海洋堂新世纪福音战士EVA成品初号机', '202109150027033', 'lucien_ssa', '2021-09-13 17:02:14', '2021-09-13 17:02:14', 0, 66, '眼镜厂', '5435341', NULL);
...
CREATE TABLE `oms_order_item`  (
  ...
  `product_attr` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品销售属性:[{\"key\":\"颜色\",\"value\":\"颜色\"},{\"key\":\"容量\",\"value\":\"4G\"}]',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单中所包含的商品' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pms_product_attribute_category`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '产品属性分类表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ums_admin` VALUES (8, 'lucien', 'd941cf1382c4ddb8c1b11620cd5d6279', '', '799774821@qq.com', 'lucien_xxx', 'cxy专用', '2021-08-25 18:10:21', '2021-09-13 14:18:13', 1);
...
CREATE TABLE `ums_admin_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户登录日志表' ROW_FORMAT = Dynamic;
